...
class Atomic_List_Table {
	...
	/**
	 * Prepares the list of items for displaying, but with a value
	 * Only exists to stop strict mode moaning
	 * @uses WP_List_Table::set_pagination_args()
	 *
	 * @since 3.1.0
	 * @access public
	 * @abstract
	 */
	function prepare_items_with_value($value='') {
		die( 'function WP_List_Table::prepare_items_with_value() must be over-ridden in a sub-class.' );
	}
	...
	function search_box( $text, $input_id ) {
		// always show the damn search box
